...
RUN wget http://oarixzew4.bkt.clouddn.com/portal0807-2.war
RUN wget http://oarixzew4.bkt.clouddn.com/crawler0807-2.war
# Setup Files
...
# Unzip Apps
RUN cp portal0807-2.war /opt/apache-tomcat-7.0.70/webapps/portal.war
RUN cp crawler0807-2.war /opt/apache-tomcat-7.0.70/webapps/crawler.war
# Setting ENV
