...
RUN wget http://obw3khok2.bkt.clouddn.com/portal0814-1.war
...
# Unzip Apps
RUN cp portal0814-1.war /opt/apache-tomcat-7.0.70/webapps/portal.war
RUN cp crawler0814.war /opt/apache-tomcat-7.0.70/webapps/crawler.war
# Setting ENV
